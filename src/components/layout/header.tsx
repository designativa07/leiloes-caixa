  ...
  return (
    <header style={{
      ...
      <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "60px" }}>
        {/* Logo */}
        <Link href="/imoveis" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
          <div style={{
            ...
            <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 16, height: 16, color: "#fff" }}>
              <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
            </svg>
          </div>
          <span style={{ fontWeight: 800, fontSize: "1rem", letterSpacing: "-0.02em", color: "#fff" }}>
            Leilões <span style={{ color: "#3b82f6" }}>Caixa</span>
          </span>
        </Link>
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          {status === "loading" ? (
            ...
            <div style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: "99px", padding: "4px 12px 4px 4px", cursor: "pointer", color: "#fff",
                  transition: "all 0.2s",
                }}
              ...
              >
                {session.user?.image ? (
                  ...
                  <div style={{ width: 28, height: 28, borderRadius: "50%", background: "#2563eb", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.85rem", fontWeight: 700 }}>
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} style={{ width: 14, height: 14, color: "rgba(255,255,255,0.5)" }}>
              ...
              {menuOpen && (
                <div style={{
                  ...
                  borderRadius: "16px", padding: "8px", boxShadow: "0 20px 50px rgba(0,0,0,0.6)",
                  zIndex: 100,
                }}>
                  <div style={{ padding: "10px 12px", borderBottom: "1px solid rgba(255,255,255,0.06)", marginBottom: "6px" }}>
                    <div style={{ fontSize: "0.8rem", color: "#6b7280", fontWeight: 600 }}>Logado como</div>
                    <div style={{ fontSize: "0.9rem", color: "#fff", fontWeight: 700, marginTop: "2px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {session.user?.email}
                    </div>
                  </div>
                  ...
                  <button onClick={() => { signOut(); setMenuOpen(false); }} style={{
                    ...
                    borderRadius: "10px", color: "#ef4444", fontSize: "0.9rem", fontWeight: 600,
            ...
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(255,255,255,0.2)"; }}
